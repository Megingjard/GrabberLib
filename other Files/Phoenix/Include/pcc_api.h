...
public:
   ...
   CPcc(CWnd* pWndParent, void (*pFnErrorHandler) (const char *, etStat, const char *) );
	CPcc(CWnd* pWndParent, ui32 dwPagesVisible, void (*pFnErrorHandler) (const char *, etStat, const char *) );
   ~CPcc();
